...
export default function consultemployeur()
{
    ...
    /* 
    CODE ( on va recuperer tous les employeurs pour les affichers dans ce tableau)
    */
    return (
        <>
        <h1>Listes des employeurs</h1>
        ...
        <table>
            <tr className={styles.tr}>
                ...
                <td className={styles.td}>Nom de la structure</td>
                <td className={styles.td}>SIRET</td>
            </tr>
            <tr className={styles.tr}>
                <td className={styles.td}>*Nom*</td>
                <td className={styles.td}>*Prenom*</td>
